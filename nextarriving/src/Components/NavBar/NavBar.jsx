import {
  ...
  import '../../Components/Footer/EmpresaF/Work With Us/NavWork.css';
  
  export default function NavBar() {
    const { isOpen, onToggle } = useDisclosure();
  
    return (
          <div className='fixed w-full animate__animated animate__fadeIn z-10 '>
          ...
          <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
            {/* <Text
              ...
              color={useColorModeValue('gray.800', 'white')}>
                ...
                <div className='lg:ml-56 h-12 lg:w-32'>
                  <Link href='/'>
             <img 
             src={logo2}
             />
            ...
            <div class=" pr-5 text-white ">
              <div className='hidden lg:block z-50'>
                <a href='/'>
                                ...
                                <div class="btn btn-ghost normal-case text-lg hover:bg-green-900 rounded-full ">Home</div>
                </a>
                            </div>
                              </div>
  ...
  <a href='/NextArriving/Zone'>
                                ...
                                <div class="btn btn-ghost normal-case text-lg hover:bg-green-900  rounded-full ">Zonas</div>
  </a>
                            </div>
                              </div>
  ...
  <label tabIndex={1} className="btn btn-ghost normal-case text-lg rounded-full ">Mas</label>
